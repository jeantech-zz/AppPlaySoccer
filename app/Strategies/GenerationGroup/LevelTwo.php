...
class LevelTwo  implements GenerationGroupInterface {
    ...
    {
        $teams=$this->gameRepositories->teamLevel(1);
        ...
        foreach($teams as $team => $values){
            ...
            $group = $this->groupRepositories->groupLevel(2,$i);
            $groupId = $group->id;
    ...
    {
        $teamgroups = $this->teamGroupRepositories->teamGroupLevel(2);
    ...
    {
        $games = $this->gameRepositories->gameLevel(2);

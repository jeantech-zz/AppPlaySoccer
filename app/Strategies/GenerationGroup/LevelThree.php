...
class LevelThree  implements GenerationGroupInterface {
    ...
    {
        $teams=$this->gameRepositories->teamLevel(2);
        ...
        foreach($teams as $team => $values){
            ...
            $group = $this->groupRepositories->groupLevel(3,$i);
            $groupId = $group->id;
    ...
    {
        $teamgroups = $this->teamGroupRepositories->teamGroupLevel(3);
    ...
    {
        $games = $this->gameRepositories->gameLevel(3);
